...
:ACO_ISO  =>TracePropertyDef("ACO_ISO",  "Acoustic isotropic parameters",     Int32,   1),
:ACO_TTI  =>TracePropertyDef("ACO_TTI",  "Acoustic TTI parameters",           Int32,   1),
:ACO_VTI  =>TracePropertyDef("ACO_VTI",  "Acoustic VTI parameters",           Int32,   1),
...
:U        =>TracePropertyDef("U",        "Local depth index (positive down)", Int32,   1),
:UPHOLE   =>TracePropertyDef("UPHOLE",   "Source uphole time",                Float32, 1),
:V        =>TracePropertyDef("V",        "Local horizontal (y) index",        Int32,   1),
:VOLUME   =>TracePropertyDef("VOLUME",   "Volume index in framework",         Int32,   1),
:W        =>TracePropertyDef("W",        "Local horizontal (x) index",        Int32,   1),
:WB_TIME  =>TracePropertyDef("WB_TIME",  "Water bottom time",                 Float32, 1),
:X        =>TracePropertyDef("X",        "Global horizontal (x) index",       Int32,   1),
:XLINE_NO =>TracePropertyDef("XLINE_NO", "3D crossline number",               Int32,   1),
:Y        =>TracePropertyDef("Y",        "Global horizontal (x) index",       Int32,   1),
:Z        =>TracePropertyDef("Z",        "Global depth index (positive up)",  Int32,   1)
)
